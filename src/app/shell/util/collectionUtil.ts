...
export class CollectionUtil {
  ...
  private static getSideBreak(chart: Chart, variable: string, index: number, nestKey?: string): Break {
    ...
    sideBreak.showOptionsSideBreak(chart.getSideBreakShownOptions(index, nestKey));
    ...
    sideBreak.setClevel(chart.includeClevel());
  ...
  private static getTopBreak(chart: Chart, variable: string, index: number, nestKey?: string): Break {
    ...
    topBreak.showOptionsTopBreak(chart.getTopBreakShownOptions(index, nestKey));
